...
class OpenCVWebCam {
    ...
    OpenCVWebCam() :it_(nh_) {
        ...
        image_sub = it_.subscribe("/camera/rgb/image_raw", 1, &OpenCVWebCam::imageCallback, this, image_transport::TransportHints("compressed"));
    ...
    void imageCallback(const sensor_msgs::ImageConstPtr& msg)
    {
        ...
        LaneAlgo(videoFrameUndistorted, perspectiveMatrix);
